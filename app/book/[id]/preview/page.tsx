  ...
  useEffect(() => {
    const fetchBook = async () => {
      try {
        ...
        if (
          !['ready', 'creating-pictures'].includes(book.status) ||
          !book.story_content
        ) {
    ...
    return (
      <div className='flex flex-col items-center justify-center min-h-screen bg-[#FFF8E8] p-6'>
        ...
        <Link
          ...
          className='text-blue-600 underline nunito-font'
        >
          Back to Dashboard
        </Link>
      </div>
      ...
      <main className='flex-1 overflow-y-auto px-4 pb-12'>
        {status === 'creating-pictures' && (
          <div className='max-w-md mx-auto mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4 text-center shadow-sm'>
            <p className='text-blue-700 nunito-font text-sm'>
              ✨ We're busy illustrating your story! Pictures will appear
        ...
        <div className='max-w-md mx-auto space-y-8'>
          {pages.map(page => {
            ...
            const pageImageUrl = pageImagePath
              ? getImageUrl(pageImagePath)
              : null;
            const bookPage = bookPages.find(
            ...
            return (
              ...
              >
                ...
                <p className='text-gray-800 nunito-font whitespace-pre-wrap'>
                  {page.text}
                </p>
                <p className='text-sm text-gray-500 nunito-font italic'>
                  Suggested: {page.imageDescription}
                </p>
              </div>
            );
          })}
