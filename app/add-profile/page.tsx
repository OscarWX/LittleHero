        ...
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="childName" className="block text-gray-800 nunito-font font-bold">
                Child's Name
              </label>
              <input
                id="childName"
            ...
            <div className="space-y-2">
              <label className="block text-gray-800 nunito-font font-bold">Gender</label>
            ...
            <div className="space-y-2">
              <label htmlFor="birthday" className="block text-gray-800 nunito-font font-bold">
                Birthday
              </label>
              <input
                id="birthday"
