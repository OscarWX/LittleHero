              ...
              <div className='space-y-4'>
                ...
                >
                  {isUploading ? (
                    <div className='text-center'>
                      <Loader2
                        size={32}
                        className='text-yellow-500 mb-2 animate-spin'
                      />
                      <p className='text-yellow-700 nunito-font'>
                        Uploading photo...
                      </p>
                    </div>
                  ) : hasPhoto ? (
                    <div className='text-center relative'>
                      ...
                      <p className='text-green-600 nunito-font font-medium'>
                ...
                <div className='bg-blue-50 p-4 rounded-lg border border-blue-200'>
                  ...
                  <ul className='text-sm text-blue-700 nunito-font mt-2 space-y-1'>
                    <li>
                      • Upload a clear, well-lit photo of your child's face
                    </li>
                    <li>• Make sure the photo shows their features clearly</li>
                    <li>• Supported formats: JPEG, PNG, WebP (max 5MB)</li>
                    <li>
                      • This will help create personalized story illustrations
                    </li>
                  </ul>
                </div>
              </div>
