...
export default function NarrativeStylePage() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      const style = selectedStyle === "personalized" ? customStyle : styleOptions.find((s) => s.id === selectedStyle)?.label || ""
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FFF8E8]">
      ...
      <header className="p-4 flex items-center">
        ...
        <h1 className="text-xl font-bold text-gray-900 ml-4">Narrative Style</h1>
      </header>

      {/* Content */}
      <main className="flex-1 p-6">
        <div className="max-w-md mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 junegull-font text-center">SELECT NARRATIVE STYLE</h2>
          ...
          {selectedStyle === "personalized" && (
            <div className="bg-white p-4 rounded-lg mb-8 border border-gray-200">
              <label htmlFor="customStyle" className="block text-gray-800 nunito-font font-bold mb-2">
          ...
          <button
            onClick={handleNext}
            disabled={selectedStyle === "" || (selectedStyle === "personalized" && customStyle === "")}
