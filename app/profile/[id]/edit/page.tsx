...
import { fetchChildProfileById, updateChildProfile, type ChildProfile, type UpdateChildProfilePayload } from "@/lib/db/child-profiles"
      ...
      <main className="flex-1 p-6 pb-20">
        <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto">
            ...
            >
              {avatarUrl ? (
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-white text-sm nunito-font">Add Photo</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-gray-800 nunito-font font-bold mb-2">
                Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label className="block text-gray-800 nunito-font font-bold mb-2">Gender</label>
              <div className="grid grid-cols-2 gap-4">
                <button
                  type="button"
                  className={`py-3 px-4 rounded-lg border-2 ${
                    gender === "boy" ? "bg-blue-100 border-blue-300" : "bg-white border-gray-200 hover:bg-gray-50"
                  }`}
                ...
                <button
                  type="button"
                  className={`py-3 px-4 rounded-lg border-2 ${
                    gender === "girl" ? "bg-pink-100 border-pink-300" : "bg-white border-gray-200 hover:bg-gray-50"
                  }`}
            ...
            <div>
              <label htmlFor="birthday" className="block text-gray-800 nunito-font font-bold mb-2">
                Birthday
              </label>
              <input
                id="birthday"
          ...
          {/* Appearance section */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-gray-900 nunito-font">Appearance</h3>
            
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="hairColor" className="block text-gray-800 nunito-font font-bold mb-2">
                  Hair Color
                </label>
                <input
                  id="hairColor"
              ...
              <div>
                <label htmlFor="eyeColor" className="block text-gray-800 nunito-font font-bold mb-2">
                  Eye Color
                </label>
                <input
                  id="eyeColor"
            ...
            <div>
              <label htmlFor="skinTone" className="block text-gray-800 nunito-font font-bold mb-2">
                Skin Tone
              </label>
              <input
                id="skinTone"
            ...
            <div>
              <label htmlFor="otherFeatures" className="block text-gray-800 nunito-font font-bold mb-2">
                Other Features
              </label>
              <textarea
                id="otherFeatures"
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-gray-900 nunito-font">Special Traits</h3>
            
            <div>
              <label htmlFor="specialTraits" className="block text-gray-800 nunito-font font-bold mb-2">
            ...
            <div>
              <label htmlFor="favoriteThing" className="block text-gray-800 nunito-font font-bold mb-2">
                Favorite Thing
              </label>
              <input
                id="favoriteThing"
