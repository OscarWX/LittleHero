    ...
    <div className="flex flex-col items-center justify-between min-h-screen bg-gradient-to-b from-yellow-100 to-orange-100 overflow-hidden relative">
      ...
      <div className="flex flex-col items-center justify-between min-h-screen py-8 px-6 z-10 max-w-md w-full">
        ...
        <div className="self-start">
          <Link href="/sign-up" className="flex items-center text-gray-700 hover:text-gray-900 transition-colors">
        ...
        <div className="flex flex-col items-center text-center mt-4 mb-8">
          ...
          <h2 className="text-xl font-bold mt-3 text-gray-800 nunito-font">Verify Your Email</h2>
        </div>
        ...
        <div className="w-full max-w-sm bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
          ...
          <h3 className="text-xl font-bold text-gray-900 nunito-font mb-2 text-center">Enter Verification Code</h3>
          ...
          <form onSubmit={handleVerifySubmit} className="space-y-4">
            <div className="space-y-2">
              <label htmlFor="verificationCode" className="block text-gray-800 nunito-font font-bold">
                Verification Code
              </label>
              <input
                id="verificationCode"
          ...
          <div className="mt-4 text-center">
            <button className="text-gray-700 hover:text-gray-900 font-bold nunito-font" onClick={handleResend}>
              Don't get it? <span className="text-yellow-600 hover:text-yellow-700">Resend!</span>
            </button>
            {resendMessage && <p className="text-green-600 text-sm mt-2 nunito-font">{resendMessage}</p>}
          </div>
        </div>
