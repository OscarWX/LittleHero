...
export default function UpdatePasswordPage() {
  ...
  // Ensure the user has a valid session (supabase will create one from the reset link)
  useEffect(() => {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-yellow-100 to-orange-100 p-6">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg w-full max-w-md text-center">
          <h1 className="text-2xl font-bold mb-4 junegull-font">Password Updated</h1>
          <p className="nunito-font mb-2">Your password has been updated successfully.</p>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-yellow-100 to-orange-100 p-6">
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg w-full max-w-md">
        <h1 className="text-2xl font-bold text-center mb-6 junegull-font">Set a New Password</h1>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="password" className="block text-gray-800 nunito-font font-bold mb-1">
              New Password
            </label>
            <input
              id="password"
          ...
          <div>
            <label htmlFor="confirm" className="block text-gray-800 nunito-font font-bold mb-1">
              Confirm Password
            </label>
            <input
              id="confirm"
