...
export interface UpdateChildProfilePayload
  extends Partial<CreateChildProfilePayload> {
  id: string;
}
...
export async function fetchChildProfileById(
  profileId: string
...
export async function createChildProfile(
  payload: CreateChildProfilePayload
...
export async function updateChildProfile(
  payload: UpdateChildProfilePayload
): Promise<ChildProfile> {
  const supabase = createSupabaseClient();
  const {
    data: { user },
